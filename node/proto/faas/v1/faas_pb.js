...
goog.exportSymbol('proto.nitric.faas.v1.SecurityScopes', null, global);
 ...
 * @constructor
 */
proto.nitric.faas.v1.SecurityScopes = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.nitric.faas.v1.SecurityScopes.repeatedFields_, null);
};
goog.inherits(proto.nitric.faas.v1.SecurityScopes, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.nitric.faas.v1.SecurityScopes.displayName = 'proto.nitric.faas.v1.SecurityScopes';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.nitric.faas.v1.SecurityScopes.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.nitric.faas.v1.SecurityScopes.prototype.toObject = function(opt_includeInstance) {
  return proto.nitric.faas.v1.SecurityScopes.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.nitric.faas.v1.SecurityScopes} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.nitric.faas.v1.SecurityScopes.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.nitric.faas.v1.SecurityScopes}
 */
proto.nitric.faas.v1.SecurityScopes.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.nitric.faas.v1.SecurityScopes;
  return proto.nitric.faas.v1.SecurityScopes.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.nitric.faas.v1.SecurityScopes} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.nitric.faas.v1.SecurityScopes}
 */
proto.nitric.faas.v1.SecurityScopes.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.nitric.faas.v1.SecurityScopes.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.nitric.faas.v1.SecurityScopes.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.nitric.faas.v1.SecurityScopes} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.nitric.faas.v1.SecurityScopes.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {!Array<string>}
 */
proto.nitric.faas.v1.SecurityScopes.prototype.getScopesList = function() {
 ...
 * @return {!proto.nitric.faas.v1.SecurityScopes} returns this
 */
proto.nitric.faas.v1.SecurityScopes.prototype.setScopesList = function(value) {
 ...
 * @return {!proto.nitric.faas.v1.SecurityScopes} returns this
 */
proto.nitric.faas.v1.SecurityScopes.prototype.addScopes = function(value, opt_index) {
 ...
 * @return {!proto.nitric.faas.v1.SecurityScopes} returns this
 */
proto.nitric.faas.v1.SecurityScopes.prototype.clearScopesList = function() {
...
proto.nitric.faas.v1.ApiWorkerOptions.toObject = function(includeInstance, msg) {
  var f, obj = {
    securityMap: (f = msg.getSecurityMap()) ? f.toObject(includeInstance, proto.nitric.faas.v1.SecurityScopes.toObject) : [],
  ...
  while (reader.nextField()) {
    ...
    case 1:
      ...
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readMessage, proto.nitric.faas.v1.SecurityScopes.deserializeBinaryFromReader, "", new proto.nitric.faas.v1.SecurityScopes());
         });
      break;
    case 2:
...
proto.nitric.faas.v1.ApiWorkerOptions.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f && f.getLength() > 0) {
    f.serializeBinary(1, writer, jspb.BinaryWriter.prototype.writeString, jspb.BinaryWriter.prototype.writeMessage, proto.nitric.faas.v1.SecurityScopes.serializeBinaryToWriter);
  }
...
/**
 * map<string, SecurityScopes> security = 1;
 * @param {boolean=} opt_noLazyCreate Do not create the map if
 * empty, instead returning `undefined`
 * @return {!jspb.Map<string,!proto.nitric.faas.v1.SecurityScopes>}
 */
proto.nitric.faas.v1.ApiWorkerOptions.prototype.getSecurityMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,!proto.nitric.faas.v1.SecurityScopes>} */ (
      jspb.Message.getMapField(this, 1, opt_noLazyCreate,
      proto.nitric.faas.v1.SecurityScopes));
};
